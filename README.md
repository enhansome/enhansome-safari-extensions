# Awesome Safari extensions with stars
...
* [SourceKit](https://github.com/kishikawakatsumi/SourceKitForSafari) ⭐ 695 | 🐛 8 | 🌐 JavaScript | 📅 2022-12-12 - Enables IDE features on your browser such as symbol navigator, go to definition and documentation on hover.

## General

* [Octotree](https://github.com/buunguyen/octotree) ⭐ 23,249 | 🐛 33 | 🌐 JavaScript | 📅 2024-06-06 - Gives a file tree view on the side of each repository that you visit that you can use to navigate over the codebase.
...
* [JSON Formatter](https://github.com/rfletcher/safari-json-formatter) ⭐ 840 | 🐛 22 | 🌐 JavaScript | 📅 2017-09-09 - Makes JSON documents that you open with the browser 'human readable' by formatting them nicely.
...
* [XML Viewer](https://github.com/sergeche/xmlview) ⭐ 338 | 🐛 37 | 🌐 JavaScript | 📅 2022-09-04 - Powerful XML viewer.
